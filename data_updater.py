...
print("2. Building AI Features and Tracking Elo...")
class EloModel:
    def __init__(self):
        self.ratings = {}
    ...
    def update(self, p1, p2, p1_win, surface, k=32):
...
for _, row in df.iterrows():
    p1, p2, surface = row["winner_name"], row["loser_name"], row["surface"]
    ...
    player_bio[p1] = {"age": a1, "hand": "L" if h1 else "R"}
    player_bio[p2] = {"age": a2, "hand": "L" if h2 else "R"}
    ...
    X.append([r1_b - r2_b, r1_s - r2_s, h2h_adv, form_adv, a1 - a2, h1 - h2])
    y.append(1)
    X.append([r2_b - r1_b, r2_s - r1_s, -h2h_adv, -form_adv, a2 - a1, h2 - h1])
    y.append(0)

    model_elo.update(p1, p2, 1, surface)
