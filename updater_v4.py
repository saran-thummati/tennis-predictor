...
print("1. RUNNING V4 SCRIPT: Requests Module with Chrome Disguise...")

# The disguise headers that requests actually respects
headers = {
...
for year in years:
    ...
    for url in urls:
        try:
            # We use requests directly so the headers are absolutely sent!
    ...
    if not success:
        print(f" -> ⚠️ Skipped {year}: Data not available yet.")
...
print("✅ V4 Automated Update Complete!")
