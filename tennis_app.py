...
with streamlit_analytics.track():
    ...
    st.write("Powered by an Optuna-Tuned Meta-Ensemble (XGBoost, LightGBM, Random Forest)")
    st.divider()
    ...
    if st.button("Predict Match Outcome", use_container_width=True):
        if p1 == p2:
            ...
            with st.spinner("Consulting the Ensemble..."):
                ...
                age1, age2 = b1.get("age", 25.0), b2.get("age", 25.0)
                p1_is_lefty, p2_is_lefty = 1 if b1.get("hand") == 'L' else 0, 1 if b2.get("hand") == 'L' else 0
                ...
                try:
                    ...
                    st.error("Model version mismatch. Please let GitHub Actions finish running or clear cache.")
