...
def compute_fatigue(player, match_dates, reference_date, days=14):
    recent = [d for d in match_dates[player] if 0 <= (reference_date - d).days <= days]
    return len(recent)

def compute_days_rest(player, match_dates, reference_date):
