...
print("1. RUNNING V3 SCRIPT: Pandas with Storage Options Disguise...")
...
for year in years:
    ...
    try:
        # We pass the disguise DIRECTLY into Pandas!
        df = pd.read_csv(url, storage_options=headers, low_memory=False)
        frames.append(df)
...
print("✅ V3 Automated Update Complete!")
